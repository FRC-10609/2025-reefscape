...
public class AlgaeCfg {
    ...
    public static final boolean ALGAE_INVERTED = true;
    public static final int ALGAE_AMP_LIMIT = 50;

    public static final double ALGAE_P_GAIN = 5.0;
    public static final double ALGAE_I_GAIN = 0.0;
    public static final double ALGAE_D_GAIN = 1.5;

    public static final double ALGAE_POS_1 = 0.03;
    public static final double ALGAE_POS_2 = 0.2;
