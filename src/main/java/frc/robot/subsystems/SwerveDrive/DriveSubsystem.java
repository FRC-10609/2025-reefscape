...
public class DriveSubsystem extends SubsystemBase {
    ...
    private final SysIdRoutine sysIdRoutine = new SysIdRoutine(
            // Create a new SysID Congig with default ramp rate (0.1 V/s), step (7V), and
            // time out values
    ...
    public DriveSubsystem() {
        ...
        // this.odometry = new SwerveDrivePoseEstimator(kinematics, getGyroRotation2d(),
    ...
    private void updateDashboard() {
        ...
        /*
         * SmartDashboard.putNumber("Robot Relative vX Speed Command",
         * speedCommands.vxMetersPerSecond);
         * SmartDashboard.putNumber("Robot Relative vY Speed Command",
         * speedCommands.vyMetersPerSecond);
         * SmartDashboard.putNumber("Robot Relative Rotation Command",
         * speedCommands.omegaRadiansPerSecond);
         */

        /*
         * SmartDashboard.putNumber("Drive Robot Relative vX Speed Command",
         * relativeCommands.vxMetersPerSecond);
         * SmartDashboard.putNumber("Drive Robot Relative vY Speed Command",
         * relativeCommands.vyMetersPerSecond);
         */
    ...
    public void driveRobotRelative(ChassisSpeeds robotRelativeSpeeds) {
        // This method is a consumer of ChassisSpeed and sets the corresponding module
        // states. This is required for PathPlanner 2024
        ...
        // Convert from robot frame of reference (ChassisSpeeds) to swerve module frame
        // of reference (SwerveModuleState)
        var swerveModuleStates = kinematics.toSwerveModuleStates(robotRelativeSpeeds);
        // Normalize wheel speed commands to make sure no speed is greater than the
    ...
    public ChassisSpeeds getRobotRelativeSpeeds() {
        // This method is a supplier of ChassisSpeeds as determined by the module
        // states. This is required for PathPlanner 2024
    ...
    public SwerveModuleState[] makeSwerveModuleState(double[] speeds, double[] angles) {
        ...
        for (int i = 0; i < angles.length; i++)
            moduleStates[i] = new SwerveModuleState(speeds[i], new Rotation2d(Units.degreesToRadians(angles[i])));
        return moduleStates;
    }
    ...
    public double getMaxLinearSpeedMetersPerSec() {
        return DrivebaseCfg.MAX_SPEED_METERS_PER_SECOND;
    }

    public double getMaxAngularSpeedRadPerSec() {
        return DrivebaseCfg.MAX_ROTATION_RADIANS_PER_SECOND;
    }
    ...
    private void configAutoBuilder() {
         ...
         * https://github.com/mjansen4857/pathplanner/blob/main/examples/java/src/main/
         * java/frc/robot/subsystems/SwerveSubsystem.java
         */
            ...
            AutoBuilder.configure(
                    ...
                    () -> {
                        ...
                        if ((alliance.isPresent()) &&
                                (!DrivebaseCfg.IS_FIELD_MIRRORED)) {// This causes a warning for dead code if
