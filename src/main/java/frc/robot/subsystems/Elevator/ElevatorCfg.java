...
public class ElevatorCfg {
    ...
    public static final double ELEVATOR_GEAR_RATIO = 1.0/27.0;
    ...
    public static final double ELEVATOR_ALGAE_POSIITION = 69;

    public static final double ELEVATOR_POSITIONS[] = {ELEVATOR_LOAD_POSITION, ELEVATOR_LONE_POSITION, ELEVATOR_LTWO_POSITION, ELEVATOR_LTHREE_POSITION, ELEVATOR_LFOUR_POSITION, ELEVATOR_ALGAE_POSIITION};
}
