...
public class ClimberSubsystem extends SubsystemBase {
    ...
    climbMotor = new SparkMax(ClimberCfg.CLIMBER_MOTOR_ID, MotorType.kBrushless);
    ...
    climbConfig.voltageCompensation(ClimberCfg.CLIMBER_MOTOR_VOLTAGE_COMP);
    climbConfig.smartCurrentLimit(ClimberCfg.CLIMBER_MOTOR_CURRENT_LIMIT);
